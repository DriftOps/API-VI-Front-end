    ...
    <div class="supervision-container">
      <div class="client-list-panel">
        ...
        <ul class="client-list">
          <li v-for="client in filteredClients" :key="client.id" @click="selectClient(client.id)"
            :class="{ active: client.id === selectedClientId }" class="client-item">
        ...
        <div class="messages-container" ref="messagesContainer">
          ...
          <div v-for="msg in selectedChatHistory" :key="msg.id" class="message-wrapper">
            ...
            <div class="comment-wrapper">
              ...
              <div v-if="msg.sender === 'assistant' && !msg.nutritionistComment && editingMessageId !== msg.id"
                class="add-comment">
...
.supervision-container {
  ...
  flex-direction: row;
  height: 100vh;
  /* ocupa a altura total do viewport */
  width: 265%;
  margin-left: -60px;
