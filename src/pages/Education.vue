...
export default defineComponent({
  ...
  setup() {
    ...
    const articles = ref<Article[]>([
      ...
      // Bem-estar
      { id:11, title:'Meditação Diária', excerpt:'Como meditar diariamente...', fullContent:'Conteúdo completo sobre meditação...', category:'wellness', readTime:'6', publishDate:'05/12/2024', image:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUxsuKNjF-xjfwbzVhgYPuXp1o9ueuwt28oQ&s' , videoUrl:'https://www.youtube.com/embed/2C23mHGzUUw?si' },
      { id:12, title:'Sono de Qualidade', excerpt:'Dicas para melhorar seu sono...', fullContent:'Conteúdo completo sobre sono...', category:'wellness', readTime:'5', publishDate:'06/12/2024', image:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfJy9MqoOOLOyIg8fpPr9nCZBRmLGWd790iA&s', videoUrl:'https://www.youtube.com/embed/_cPSjc8OZ_w?si' },
      { id:13, title:'Gerenciamento de Stress', excerpt:'Como lidar com o stress cotidiano...', fullContent:'Conteúdo completo sobre gerenciamento de stress...', category:'wellness', readTime:'7', publishDate:'07/12/2024', image:'https://cedplan.com.br/wp-content/uploads/2024/06/41505-1024x683.jpg' , videoUrl:'https://www.youtube.com/embed/crDLkOFW4OQ?si' }
    ])
